...
public class Car implements Serializable{
	...
	public String toString() {
		return "Car [certificate=" + certificate + ", direction=" + direction
				+ ", driverIDCard=" + driverIDCard + ", driverName="
				+ driverName + ", elevation=" + elevation + ", gasSolubility="
				+ gasSolubility + ", id=" + id + ", latitude=" + latitude
	...
	public Car(String id, String driverName, String driverIDCard,
			...
			String oil, String tirePressure, String gasSolubility,
			String mileage, String pathID) {
		super();
		this.id = id;
		this.driverName = driverName;
		this.driverIDCard = driverIDCard;
