    			...
    			while(true){
	                ...
	                while(-1 != length){
	                      ...
	                      if(fBase.getm_FrameHead().getID() == FrameType.MSG_WZXXHB){
	    			        	  ...
	    			        	  //传输过来的经纬度反了
	    			        	  LatLng ll = new LatLng(fa.getM_dlatitude(), fa.getM_dlongitude());
	    			      		  ll = CoordinateUtil.transformFromWGSToGCJ(ll);
	    			      		  car.setLatitude(String.valueOf(ll.longitude));
	    			      		  car.setLongitude(String.valueOf(ll.latitude));
	    			        	  ...
	    			        	  //传输过来的经纬度反了
	    			        	  ll = new LatLng(fa.getM_dlatitude(), fa.getM_dlongitude());
	    			      		  ll = CoordinateUtil.transformFromWGSToGCJ(ll);
	    			        	  restCar.setLatitude(String.valueOf(ll.longitude));
	    			        	  restCar.setLongitude(String.valueOf(ll.latitude));
